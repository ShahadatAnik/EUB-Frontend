            ...
            <div className='space-y-4'>
              <div>
                <h5 className='mb-2 font-medium'>
                  1. Course Withdrawal: If a student cannot complete the
                  semester Final Examination due to illness, accident, or any
                  other valid reason, etc., he/she may apply for withdrawal from
                  a semester. The following steps will be maintained during
                  withdrawal:
                </h5>
              ...
              <div>
                <h5 className='mb-2 font-medium'>
                  ...
                  examination. In Lab or Sessional Courses, if any student
                  failed to attend the final lab quiz, then he/she will get
                  Incomplete (I) in that course. In that case, he/she must
                  retake that course.
                </h5>
              </div>
              ...
              <div>
                <h5 className='mb-2 font-medium'>
                  3. Retake: Students can retake a course
                  (Theory/Sessional/Lab). In the case of a theory course, the
                  student can retake a course if the student fails in that
                  course and cannot secure pass marks even after giving the
                  supplementary examination. In the case of a lab/sessional
                  course, a student can retake a course if the student fails or
                  could not complete that course.
                </h5>
              </div>
