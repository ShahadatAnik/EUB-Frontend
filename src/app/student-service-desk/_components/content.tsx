		...
		<div className='grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-8'>
			...
			<ServiceCard title='Registration Services'>
				<ul className='list-disc space-y-2 pl-6'>
					...
					<li>
						Registration required as per the notice circulated by the Office of the Registrar.
					</li>
			...
			<ServiceCard title='Examination Service Desk'>
				<ul className='list-disc space-y-2 pl-6'>
					...
					<li className='space-x-1'>Collect admit card from cluster-wise exam office.</li>
					<li className='space-x-1'>
						Publish semester results and provide transcripts and certificates.
					</li>
					<li className='space-x-1'>
						In case of sickness or unavoidable situations, provision for supplementary exams.
					</li>
				</ul>
			</ServiceCard>
			...
			<ServiceCard title='Accounts Service Desk'>
				<ul className='list-disc space-y-2 pl-6'>
					...
					<li>After registration, pay semester fees before mid and final term exams.</li>
					<li>Without clearing dues, no one will be allowed to sit for exams.</li>
					<li>50% of admission fees should be paid in case of a 3-semester registration gap.</li>
				</ul>
			</ServiceCard>
				...
				<ul className='list-disc space-y-2 pl-6'>
					<li>
						...
						<ul className='mt-1 list-disc space-y-1 pl-6'>
							<li>
								<strong>
									Hours: 9:00 AM - 5:00 PM (Sunday to Wednesday), 9:00 AM - 8:00 PM (Thursday,
									Friday, and Saturday).
								</strong>
							</li>
						</ul>
					...
					<li>Borrow up to 2 books for 10 days; defaulters fined Tk 2 per day.</li>
					<li>Lost books must be replaced by the borrower.</li>
					<li>Without library clearance, students cannot collect certificates.</li>
				</ul>
			</ServiceCard>
				...
				<ul className='list-disc space-y-4 pl-6'>
					<li>
						...
						<ul className='mt-1 list-disc space-y-2 pl-6'>
							...
							<li>Assistant Manager, Program Coordination, Cluster II: Room 512</li>
							<li>Senior Coordination Officer, In-Charge Cluster III: Room 603</li>
						</ul>
					</li>
					<li>
			...
			<div className='space-y-4 lg:space-y-8'>
				...
				<ServiceCard title='Offices of the Departmental Teacher'>
					<ul className='list-disc space-y-2 pl-6'>
						<li>
							<strong className='font-semibold'>Civil Engineering: </strong> Room 312, 328, 428, 528
						</li>
						<li>
							<strong className='font-semibold'>Business Administration: </strong> Room 628
						</li>
						<li>
