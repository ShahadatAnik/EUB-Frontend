...
const ProgramDetails = () => {
	return (
		<ContentWrapper title='Program Details' className='space-y-8'>
			<p>
				The LL.M. (Preliminary) program is a one-year degree divided into 3 semesters. The LL.M.
				(Final) program is also a one-year degree divided into 3 semesters. An academic year
				consists of three semesters: Spring (January – April), Summer (May – August), and Fall
				(September – December). Each semester lasts 15 weeks, including 13 weeks of classroom
				instruction, one week for examination preparation, and one week for examinations. The medium
				of instruction for the program is English, ensuring students develop strong legal
				communication skills. Additionally, all courses in the LL.M. programs are compulsory,
				providing a comprehensive legal education that prepares graduates for careers in the legal
			...
			<div>
				...
				<p>
					The program comprises 12 semesters (trimesters), each spanning four months. Of these, 11
					semesters are dedicated to coursework, while the final semester is reserved for an
					internship or project. The academic year is structured into three semesters: Spring,
					Summer, and Fall.
				</p>
			...
			<div>
				...
				<p>
					4 months [13 weeks of classroom instruction, one week for examination preparation, and one
					week for examinations]
				</p>
			</div>
			<div>
			...
			<div>
				...
				<p>
					In each semester, students are required to complete four courses, totaling 12 credits. In
					the 12th semester, they must undertake a 3-credit internship/project along with a 1-credit
					Applied Research Methodology course.
				</p>
			</div>
			<div>
