...
const ProgramDetails = () => {
	return (
		<ContentWrapper title='Program Details' className='space-y-8'>
			<p>
				The BA (Honours) in English at the European University of Bangladesh is a broad-based,
				multidisciplinary program designed to equip graduates with the skills needed to meet the
				demands of a rapidly evolving society. The curriculum is structured around foundational
				courses that broaden students’ perspectives, along with support courses that enhance their
				understanding of core subjects. This four-year, full-time day program consists of 12 regular
				terms, requiring students to complete 40 courses totaling 120 credit hours. Students will
				receive letter grades for their coursework, while the Comprehensive Examination and thesis
			...
			<div>
				...
				<p>The program comprises 132 credits, including a 3-credit internship/project.</p>
			</div>
			<div>
