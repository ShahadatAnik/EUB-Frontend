...
const ProgramDetails = () => {
	return (
		<ContentWrapper title='Program Details' className='space-y-8'>
			<p>
				The LL.B. (Hons.) program is a four-year undergraduate degree divided into 12 semesters. An
				academic year consists of three semesters: Spring (January – April), Summer (May – August),
				and Fall (September – December). Each semester lasts 15 weeks, including 13 weeks of
				classroom instruction, one week for examination preparation, and one week for examinations.
				The medium of instruction for the program is English, ensuring students develop strong legal
				communication skills. Additionally, all courses in the LL.B. (Hons.) program are compulsory,
