...
const ProgramDetails = () => {
	return (
		<ContentWrapper title="Program Details" className="space-y-8">
			<p>
				The Master of Business Administration (MBA) program (1-Year) at
				the European University of Bangladesh is designed to provide
			...
			<div>
				...
				<p>
					The program comprises 3 semesters (trimesters), each
					spanning four months. The academic year is structured into
			...
			<div>
				...
				<p>
					...
					courses, totaling 12 credits (second semester has a course
					load of 3 courses or 9 credits). In the 3rd semester, they
					must undertake a 3-credit internship/project along with the
					major courses.
				</p>
			</div>
			<div>
