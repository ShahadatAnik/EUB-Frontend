...
const ProgramDetails = () => {
	return (
		<ContentWrapper title='Program Details' className='space-y-8'>
			<p>
				The Master of Business Administration (MBA) program (1-Year) at the European University of
				Bangladesh is designed to provide students with a comprehensive understanding of
				contemporary business and management principles. The program is tailored for recent business
				graduates entering the job market and individuals aspiring to become entrepreneurs. It
				offers concentrations in Finance, Accounting, Human Resource Management, and Marketing.
			</p>

			<div>
				<Title variant={'title'} title='Semesters' />
				<p>
					The program comprises 3 semesters (trimesters), each spanning four months. The academic
			...
			<div>
				...
				<p>The program comprises 36 credits, including a 3-credit internship/project.</p>
			</div>
			<div>
				<Title variant={'title'} title='Course Load' />
				<p>
					In each semester, students are required to complete four courses, totaling 12 credits
					(second semester has a course load of 3 courses or 9 credits). In the 3rd semester, they
					must undertake a 3-credit internship/project along with the major courses.
				</p>
			</div>
			<div>
