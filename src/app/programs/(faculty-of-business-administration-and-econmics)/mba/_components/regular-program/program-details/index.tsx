...
const ProgramDetails = () => {
	return (
		<ContentWrapper title='Program Details' className='space-y-8'>
			<p>
				The Master of Business Administration (MBA) program at the European University of Bangladesh
				is designed to provide students with a comprehensive understanding of contemporary business
				and management principles. The program is tailored for recent graduates entering the job
				market and individuals aspiring to become entrepreneurs. It offers concentrations in
				Finance, Accounting, Human Resource Management, and Marketing.
			</p>

			<div>
				<Title variant={'title'} title='Semesters' />
				<p>
					The program comprises 6 semesters (trimesters), each spanning four months. Of these, 5
			...
			<div>
				...
				<p>The program comprises 63 credits, including a 3-credit internship/project.</p>
			</div>
			<div>
				...
				<p>
					...
					the 6th semester, they must undertake a 3-credit internship/project.
				</p>
			</div>
			<div>
				<Title variant={'title'} title='Performance Evaluation Criterion' />
				<p className='mb-4'>
					The final grade for each course will be determined based on students&lsquo; performance in
