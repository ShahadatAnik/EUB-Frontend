...
const ProgramDetails = () => {
	return (
		<ContentWrapper title="Program Details" className="space-y-8">
			<p>
				The Master of Business Administration (MBA) program at the
				...
				recent graduates entering the job market and individuals
				aspiring to become entrepreneurs. It offers concentrations in
			...
			<div>
				...
				<p>
					The program comprises 6 semesters (trimesters), each
					spanning four months. Of these, 5 semesters are dedicated to
					coursework, while the final semester is reserved for an
			...
			<div>
				...
				<p>
					...
					courses, totaling 12 credits. In the 6th semester, they must
					undertake a 3-credit internship/project.
				</p>
			</div>
			<div>
				<Title
				...
				<p className="mb-4">
					...
					students&lsquo; performance in class attendance, continuous
