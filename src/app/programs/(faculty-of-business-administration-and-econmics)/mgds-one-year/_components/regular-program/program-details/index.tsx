	...
	return (
		<ContentWrapper title='Program Details' className='space-y-8'>
			<div>
				...
				<p>
					Semesters: The program comprises 3 semesters (trimesters), each spanning four months. Of
					these, 2 semesters are dedicated to coursework, while the final semester is reserved for
					thesis or project. The academic year is structured into three semesters: Spring, Summer,
					and Fall.
				</p>
			...
			<div>
				...
				<p>
					...
					the 3rd semester, they must undertake a 3-credits thesis along with 12-credits course.
				</p>
			</div>
			<div>
