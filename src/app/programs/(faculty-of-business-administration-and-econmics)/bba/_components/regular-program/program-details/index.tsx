...
const ProgramDetails = () => {
	return (
		<ContentWrapper title="Program Details" className="space-y-8">
			<p>
				The BBA program at the European University of Bangladesh is
				ideal for those seeking a future with more opportunities and
				fewer limitations. Students in this program acquire practical
				business knowledge, learn the essentials of starting a
				successful business, and develop the skills needed to thrive in
				the corporate world. The BBA program at EUB offers
				specialization in various business disciplines, including
				Finance, Accounting, Human Resource Management, and Marketing.
				Furthermore, the university boasts a team of dedicated teachers
				who are always ready to support students both in class and
				outside class hours.
			</p>
			...
			<div>
				...
				<p>
					The program comprises 12 semesters (trimesters), each
					spanning four months. Of these, 11 semesters are dedicated
					to coursework, while the final semester is reserved for an
					internship or project. The academic year is structured into
			...
			<div>
				...
				<p>
					The program comprises 136 credits, including a 3-credit
					internship/project.
				</p>
			</div>
			<div>
				...
				<p>
					...
					courses, totaling 12 credits. In the 12th semester, they
					must undertake a 3-credit internship/project along with a
					1-credit Applied Research Methodology course.
				</p>
			</div>
			<div>
				<Title
