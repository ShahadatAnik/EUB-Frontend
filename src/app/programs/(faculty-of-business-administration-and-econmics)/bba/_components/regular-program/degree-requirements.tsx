...
const DegreeRequirements = () => {
	return (
		<ContentWrapper title='Degree Requirements' className='space-y-6'>
			<p>
				To successfully complete the program, students must complete 136 credits, comprising 45
				courses (133 credits) and 1 internship/project (3 credits).
			</p>
			...
			<div>
				...
				<p>
					Students must complete a 3-credit internship/project to fulfill the program requirements.
				</p>
			</div>
		</ContentWrapper>
	);
