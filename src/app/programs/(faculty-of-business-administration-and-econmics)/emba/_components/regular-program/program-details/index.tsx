...
const ProgramDetails = () => {
  return (
    <ContentWrapper title='Program Details' className='space-y-8'>
      <p>
        The EMBA program at the European University of Bangladesh is designed to
        provide students with a comprehensive understanding of contemporary
        business and management principles. The program is tailored for business
        executives, government officials, social entrepreneurs, NGO officials,
        military personnel, and other professionals. It offers concentrations in
        Finance, Accounting, Human Resource Management, and Marketing. The
        Master of Business Administration (MBA) program (1-Year) at the European
      ...
      <div>
        ...
        <p>
          The program comprises 4 semesters (trimesters), each spanning four
          months. Students are required to undertake an internship or a project
          along with their coursework in the final semester. The academic year
          is structured into three semesters: Spring, Summer, and Fall.
        </p>
      ...
      <div>
        ...
        <p>
          ...
          totaling 12 credits (third semester has a course load of 3 courses or
          9 credits). In the final semester, they must undertake a 3-credit
          internship/project.
        </p>
      </div>
      <div>
