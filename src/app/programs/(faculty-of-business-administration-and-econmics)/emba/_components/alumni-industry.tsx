	...
	const data: IAlumni[] = [
		{
			...
			image: '/images/programs/emba/alumni/Md. Shahadat Hossain Miah (EMBA 30th).png',
			designation: 'Chief Financial Officer (CFO), Aftab Automobile Limited, Navana Group',
		...
		},
		{
			...
			image: '/images/programs/emba/alumni/Mohammad Abdul Qayum (EMBA 32nd).jpg',
