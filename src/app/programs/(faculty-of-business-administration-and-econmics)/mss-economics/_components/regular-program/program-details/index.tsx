...
const ProgramDetails = () => {
	return (
		<ContentWrapper title='Program Details' className='space-y-8'>
			<p>
				The MSS in Economics is a 39-credit-hour program spanning three semesters.The program is
				conducted in English, and students must maintain a CGPA of 3.00 or higher to graduate. If a
				student fails a course, they may retake the examination in a subsequent semester to improve
				their grade.
			</p>
