		...
		<ContentWrapper title='Program Details' className='space-y-8'>
			<div>
				...
				<p>
					...
					semesters are dedicated to coursework, while the final semester is reserved for thesis or
					project. The academic year is structured into three semesters: Spring, Summer, and Fall.
				</p>
			...
			<div>
				...
				<p>
					...
					the 12th semester, they must undertake a 6-credits thesis along with a 3-credit course.
				</p>
			</div>
			<div>
