...
const DegreeRequirements = () => {
	return (
		<ContentWrapper title='Degree Requirements' className='space-y-6'>
			<p>
				To graduate from the program, students must complete a total of 132 credits, consisting of
				43 courses (129 credits) and a 3-credit internship.
			</p>
			...
			<div>
				...
				<p>
					(Not applicable; please consult the credit transfer guidelines for eligibility and
					requirements).
				</p>
			</div>
		</ContentWrapper>
