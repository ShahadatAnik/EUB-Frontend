		...
		<div className='py-6 lg:py-12'>
            ...
            transcript but are not counted in calculating the GPA."
				...
				<SectionContent
					...
					content={
						<p>
							EUB students are graded on GPA. Comparison of the GPA earned by EUB students to the
							Classes earned by students in other universities in the country is as follows:
							<br />
				...
				<SectionContent
					...
					content={
						<p>
							The grade of Incomplete (I) may be used in special circumstances. The Incomplete may
							be given only at the end of a semester to a student whose work is progressing but who
							has left unfinished a small amount of work for completion without further class
							attendance. The instructor must file with the Registrar an Incomplete Grade form
							describing the work to be completed, indicating a tentative final grade to be assigned
							if the work is not completed and the time period in which the work must be completed
							(no longer than the following semester).
							<br />
							The student has the responsibility to take the initiative in completing the work and
							is expected to make up the incomplete as specified by the instructor. If action is not
							taken, the &quot;I&#34; grade will revert to the tentative final grade. The final
							grade becomes an &quot;F&quot; if no tentative grade is assigned. In the event the
							instructor from whom a student received an incomplete is not available, the
							disposition of a case involving an incomplete grade resides with the Chair of the
							department. The grade &apos;I&apos; must be replaced within one semester after the
							grade is assigned.
						</p>
					}
				/>
