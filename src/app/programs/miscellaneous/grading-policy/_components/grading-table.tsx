		...
		<div className='space-y-4'>
			...
			<div>
				...
				<p>
					...
					instructor. The same applies to the assignment of + or - after a letter grade. It is meant
					to give more flexibility so that shades of performance can be distinguished and rewarded.
					The + and - has a value of 0.3 grade point.
				</p>
			</div>
		</div>
	);
