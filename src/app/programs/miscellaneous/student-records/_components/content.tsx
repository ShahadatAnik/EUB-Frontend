    ...
    <div className='py-6 lg:py-12'>
      <div className='container space-y-8'>
        ...
        <SectionContent
          ...
          content={
            <p>
              Certain information concerning students is open to the public upon
              ...
              athletic teams.
              <br />
              Directory information as defined above will be released for
              individual students by the Office of the Registrar to anyone upon
              inquiry, unless the student has requested within ten days after
              registering that specific items not be released. The
              student&apos;s request to have directory information withheld must
              be submitted for each semester the student is registered and
              should be made at the Office of the Registrar, which will notify
        ...
        <SectionContent
          ...
          content={
            <p>
              ...
              academic records. Because the transcript contains confidential
              information, it can be released to the student, or parents of a
              dependent student, or an authorized person with a specific request
              signed by the student.
              <br />
              The required fee for the transcript must be paid in advance
              through RDS or nominated banks. A transcript request must be made
              through RDS or by submitting the completed application form at the
          ...
          content={
            <div>
              <p>
                ...
                to complete degree requirements. This can be done in less than
                four years if a student registers for more than two semesters in
                some years, has sufficient proficiency in English and
                Mathematics, and plans the schedules well. Students are
                responsible for meeting the requirements of their curriculum.
                Before selecting the courses in each semester, students should
                consult their academic advisor. The University reserves the
              ...
              <ul className='list-decimal list-inside space-y-1'>
                ...
                <li>
                  <span className='italic'>
                    Completion of all course requirements for the degree
                    including Ged, core, concentration/major, minor etc.
                  </span>
                </li>
                <li>
                  <span className='italic'>
                    A student must get an overall CGPA 2.00 (C) on a scale of
                    4.00 to be qualified for his/ her degree. CGPA 2.00 (C) is
                    required in all categories and CGPA 2.5 in the
                    Concentration/ Major, Minor category to qualify for the
                    degree with Concentration/ Major, Minor. If any student is
                    unable to get CGPA 2.5 in Concentration/ Major, Minor
                    category, s/he must get CGPA 2.00 to qualify for the degree
                    without Concentration/ Major, Minor.
                  </span>
                </li>
                <li>
                  <span className='italic'>
                ...
                <li>
                  <span className='italic'>
                    Fulfillment of the above conditions does not necessarily
                    mean that a degree will be conferred on the student. The
                    University reserves the right to refuse the awarding of a
                    degree on disciplinary and other grounds.
                  </span>
                </li>
              </ul>
              <p className='mt-2 mb-1 font-medium'>
              ...
              <ul className='list-disc list-inside space-y-2'>
                ...
                <li>
                  ...
                  <p className=' mt-0.5 '>
                    ...
                    must get a CGPA 2.5 in this category to qualify for the
                    degree with Minor. Minor broadens students&apos;
                    specialization and increases their marketability.
                  </p>
                </li>
                <li>
                  ...
                  <p className=' mt-0.5 '>
                    ...
                    electives are selected according to availability and the
                    student’s preference. Students can take open elective
                    courses from any area.
                  </p>
                </li>
                <li>
                  ...
                  <p className='mt-0.5 '>
                    ...
                    in this category to qualify for the degree with Dual Major.
                  </p>
                </li>
              </ul>
            </div>
