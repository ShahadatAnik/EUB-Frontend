...
const DegreeRequirements = () => {
	return (
		<ContentWrapper title='Degree Requirements' className='space-y-6'>
			<p>
				To complete the Bachelor of Science in Industrial and Production program successfully,
				...
				<ul className='list-disc space-y-2 pl-6'>
					<li>
						...
						<ul className='mt-2 space-y-1'>
							<li>
								SSC & HSC (or equivalent) in Science group with at least 2nd division or CGPA 2.5
							</li>
							<li>O/A-Level: Minimum average B grade with Math, Physics, and Chemistry</li>
						</ul>
					</li>
					<li>
						<strong>Diploma Holders:</strong>
						<ul className='mt-2 space-y-1'>
							<li>Accepted from relevant engineering backgrounds (e.g., Electrical, Mechanical)</li>
					...
					<li>
						...
						<ul className='mt-2 space-y-1'>
							...
							<li>Must have security clearance from their respective embassies in Bangladesh</li>
						</ul>
					</li>
				</ul>
			</div>
			...
			<div>
				...
				<p>(Not specified; may include project/thesis as outlined in evaluation criteria)</p>
			</div>
		</ContentWrapper>
	);
};
