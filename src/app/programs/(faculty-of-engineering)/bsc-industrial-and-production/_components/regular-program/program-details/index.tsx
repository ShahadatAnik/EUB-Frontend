...
const ProgramDetails = () => {
	return (
		<ContentWrapper title='Program Details' className='space-y-8'>
			<p>
				The B.Sc. in Industrial and Production Engineering (IPE) program at the European University
				of Bangladesh (EUB) is designed to prepare students for careers in industrial operations,
				production systems, manufacturing engineering, and quality management. Through a balanced
				curriculum of theory and lab courses, the program aims to equip graduates with the skills
				necessary to improve productivity, reduce waste, and manage technological processes across
				various industries.
			</p>
			...
			<div>
				...
				<ul className='list-disc space-y-1.5 pl-6'>
					<li>Theory Course: 3 credits = 3 lecture hours/week (50 minutes/class)</li>
					<li>Lab Course: 1 credit = 24 hours/semester, minimum 2-hour sessions</li>
				</ul>
			</div>
			<div>
