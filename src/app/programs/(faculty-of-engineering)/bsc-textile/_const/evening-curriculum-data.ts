...
export const eveningNonDepartmentalCourses: Course[] = [
  ...
  { sl: 26, code: 'TXE-310', title: 'Elements of Machine Design', credits: 3 },
...
export const eveningSemesterData: Semester[] = [
  ...
  },
  {
    ...
    courses: [
      { slNo: 1, courseCode: 'PHY-109', courseTitle: 'Physics I', credit: 3 },
      {
        slNo: 2,
        courseCode: 'PHY-110',
      ...
      { slNo: 3, courseCode: 'CHM-107', courseTitle: 'Chemistry I', credit: 3 },
      {
        slNo: 4,
        courseCode: 'CHM-108',
  ...
  },
  {
    ...
    courses: [
      { slNo: 1, courseCode: 'PHY-111', courseTitle: 'Physics II', credit: 3 },
      {
        slNo: 2,
        courseCode: 'PHY-112',
