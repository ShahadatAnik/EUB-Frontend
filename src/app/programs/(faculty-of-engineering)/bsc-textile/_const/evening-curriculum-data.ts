...
export const eveningProgramDetails: ProgramDetails = {
	...
	courseLoadDetails: '(12 Weeks class + 2 Weeks Exam + 2 Weeks Result Processing)',
	minimumGPA: 2.2,
		...
		courses: [
			{
				...
				courseTitle: 'Yarn/Fabric/Wet Processing/Apparel Manufacturing Technology III (Any one)',
				credit: 3,
			},
			{
				slNo: 2,
		...
		courses: [
			{
				...
				courseTitle: 'Yarn/Fabric/Wet Processing/Apparel Manufacturing Technology IV (Any one)',
				credit: 3,
			},
			{
				slNo: 2,
				courseCode: 'TXE-410/412/414/416',
				courseTitle: 'Yarn/Fabric/Wet Processing/Apparel Manufacturing Technology IV Lab (Any one)',
				credit: 1.5,
			},
			{
				slNo: 3,
	...
	},
	{
		...
		courses: [
			...
			},
			{
				slNo: 4,
				courseCode: 'TXE-413',
				courseTitle: 'Forecasting and Trend Analysis of Textile and Apparel Business',
				credit: 2,
			},
			{
				slNo: 5,
