...
const ProgramDetails = () => {
	return (
		<ContentWrapper title='Program Details' className='space-y-8'>
			<p>
				The Bachelor of Science in Textile Engineering at the European University of Bangladesh is
				designed to equip students with in-depth knowledge and practical skills in textile science,
				manufacturing, and production. The program emphasizes hands-on learning, integrating
				laboratory work, field activities, and real-world projects to prepare graduates for the
				dynamic demands of the global textile industry. EUB&apos;s experienced faculty ensures that
				students receive both academic guidance and professional mentorship, helping them excel in
