...
export const CurriculumSection = React.memo<CurriculumSectionProps>(
	({
		...
		const textileTotal = useMemo(
			() => textileEngineeringCourses.reduce((sum, course) => sum + course.credits, 0),
			[textileEngineeringCourses]
		);
		...
		return (
			<div>
				...
				<div className='mb-8'>
					<h4 className='mb-4 font-semibold'>a. Textile Engineering Core Courses & Lab:</h4>
					<p className='mb-4 text-sm text-gray-600'>
						23 Theory Courses & 12 Lab Courses (Total: {textileTotal} Credits)
					</p>
					<CourseTable courses={textileEngineeringCourses} totalCredits={textileTotal} />
				</div>
				...
				<div className='mb-8'>
					...
					<p className='mb-2 text-sm text-gray-600'>
						i. General Education Courses (Inter Disciplinary Engineering Courses include ICT/
						Computer, Technical Elective Courses, Basic Science), Compulsory Courses, Social Science
						& Humanities:
					</p>
					<p className='mb-4 text-sm text-gray-600'>
						24 Theory Courses & 7 Lab (Total: {nonDeptTotal} Credits)
					</p>
					<CourseTable courses={nonDepartmentalCourses} totalCredits={nonDeptTotal} />
				</div>
				...
				<div className='mb-8'>
					...
					<p className='mb-4 text-sm text-gray-600'>3 Courses (Total: {projectTotal} Credits)</p>
				...
				<div className='mb-8'>
					<h4 className='mb-4 font-semibold'>
						2.2.3. Course Structure: The B. Sc. in Textile Engineering Program consists of the
