...
const PerformanceCriteriaTable = () => {
	return (
		<div className='space-y-8'>
			<SystemTable caption='Theory Courses' data={theoryCourses} columns={columns}>
				<TableFooter>
					<TableRow>
			...
			<SystemTable caption='Laboratory/Sessional/Field Work Courses' data={labs} columns={columns}>
				<TableFooter>
					<TableRow>
						<TableCell className='border-r'>Total</TableCell>
						<TableCell>100</TableCell>
			...
			<SystemTable caption='Project and Thesis' data={projectAndThesis} columns={columns}>
				<TableFooter>
					<TableRow>
						<TableCell className='border-r'>Total</TableCell>
						<TableCell>100</TableCell>
