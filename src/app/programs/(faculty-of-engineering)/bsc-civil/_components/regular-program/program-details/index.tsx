...
const ProgramDetails = () => {
	return (
		<ContentWrapper title="Program Details" className="space-y-8">
			<p>
				The Bachelor of Science in Civil Engineering at the European
				University of Bangladesh (EUB) equips students with the
				knowledge and practical skills necessary for designing,
				constructing, and maintaining infrastructure projects that shape
				the modern world. From bridges and roads to buildings and water
				supply systems, the Civil Engineering program empowers future
				engineers to innovate and contribute meaningfully to sustainable
				development. The program is supported by dedicated faculty
				members and modern lab facilities, ensuring that students
				receive both theoretical understanding and hands-on experience.
			</p>

			<div>
				<h6 className="text-lg font-semibold">
					The program comprises 12 semesters, with each semester
					lasting four months. These are distributed across the
			...
			<div>
				...
				<p>
					Each semester includes 16 weeks of classes, covering theory
					and practical courses, as well as project and thesis work in
