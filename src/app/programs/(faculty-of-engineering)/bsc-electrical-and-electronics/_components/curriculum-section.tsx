			...
			<div>
				...
				<div className='mb-8'>
					...
					<p className='mb-4 text-sm text-gray-600'>
						23 Theory Courses, 18 Laboratory (Lab) Courses (Total: {coreTotal} Credits)
					</p>
				...
				<div className='mb-8'>
					<h4 className='mb-4 font-semibold'>b. List of Prerequisite Courses</h4>

					{/* General Education */}
					<div className='mb-6'>
						<h5 className='mb-2 font-medium'>(I) General Education Courses: English & Others</h5>
						<p className='mb-4 text-sm text-gray-600'>
							Any Five including GED-101 (Compulsory) (Total: {generalTotal} Credits)
						</p>
					...
					<div className='mb-6'>
						...
						<p className='mb-4 text-sm text-gray-600'>
							9 Theory Courses and 3 Laboratory Courses (Total: {basicScienceTotal} Credits)
						</p>
					...
					<div className='mb-6'>
						<h5 className='mb-2 font-medium'>(III) Inter-Disciplinary Engineering Courses</h5>
						<p className='mb-4 text-sm text-gray-600'>
							2 Theory Courses, 1 Laboratory (Lab) Course (Total: {interDisciplinaryTotal} Credits)
						</p>
				...
				<div className='mb-8'>
					...
					<ElectiveCourseTable courses={electiveCourses} totalCredits={electiveTotal} />
				</div>
				...
				<div className='mb-8'>
					...
					<p className='mb-4 text-sm text-gray-600'>
						The first digit in the number indicates the year/level for which the course is intended,
						the second digit in the number indicates for the Department and the last digit, if odd,
						indicates a theory course and if even, indicates a laboratory course.
					</p>
