...
export const eeeCoreCoursesData: Course[] = [
  ...
  { sl: 15, code: 'EEE-210', title: 'Electrical Machines-II Lab', credits: 1 },
  ...
  { sl: 30, code: 'EEE-318', title: 'Engineering Simulation Lab', credits: 1 },
...
export const eeeBasicScienceCourses: Course[] = [
  ...
  { sl: 10, code: 'MTH-203', title: 'Probability and Statistics', credits: 3 },
  {
    sl: 11,
    code: 'MTH-205',
