...
export const eeeRegularProgramDetails: ProgramDetails = {
	degreeName: 'Bachelor of Science in Electrical and Electronic Engineering (B.Sc. in EEE)',
	duration: {
		years: 4,
		semesters: 12,
	},
...
export const eeeElectiveCourses: ElectiveCourse[] = [
	...
	},
	{
		...
		titles: ['Renewable Energy', 'Optoelectronics', 'Wireless and Mobile Communication'],
		credits: 3,
	},
	{
		sl: 5,
	...
	},
	{
		...
		courses: [
			...
			},
			{
				slNo: 4,
				courseCode: 'GED-101',
				courseTitle: 'Bangladesh Studies (History of Independence of Bangladesh)',
				credit: 3,
				contactHours: 3,
			},
			{
