...
export const YearGroupCard = React.memo<YearGroupCardProps>(({ year, semesters }) => {
					...
					{semesters.map((semester, index) => (
						...
						>
							...
							<div className='border-b bg-blue-50 px-4 py-3'>
								<h4 className='text-lg font-semibold text-blue-900'>{semester.title}</h4>
							</div>
									...
									<TableBody>
										{semester.courses.map((course, courseIndex) => (
											<TableRow
												...
												className={courseIndex % 2 === 0 ? 'bg-white' : 'bg-gray-50/50'}
											>
