...
export const PerformanceEvaluationSection = React.memo<PerformanceEvaluationProps>(
	({ evaluations }) => {
		...
		return (
			<div>
				<h4 className='mb-4 font-semibold'>2.1.5. Performance Evaluation Criterion:</h4>
					...
					{evaluations.map((evaluation, evalIndex) => {
						...
						return (
							<div key={evalIndex}>
								...
								<SystemTable data={tableData} columns={columns} className='overflow-hidden' />
							</div>
						);
					})}
				</div>
