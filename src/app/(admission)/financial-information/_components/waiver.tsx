...
const Waiver = () => {
	return (
		<div>
			<p>
				European University of Bangladesh provides a significant number of scholarships and
				financial assistance to the students. It also offers tuition waiver (full/partial) to
				deserving students. Further information may be obtained from the Admission office:
			</p>

			<div className='mt-4 space-y-6'>
				<div>
					<h4 className='text-lg font-medium'>Financial Assistance based on SSC & HSC Results</h4>
				...
				<div>
					...
					<p>
						Students are encouraged to pay fees directly to the EUB Bank Account. Students are
						advised to collect Fees Account Number and bank address from the Admission office in
						person or by phone.
					</p>
				</div>
			</div>
