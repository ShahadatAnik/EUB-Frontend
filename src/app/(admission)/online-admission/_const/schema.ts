...
export const formSchema = z.object({
  ...
  ssc_registration_number: z
    ...
    .regex(/^\d+$/, { message: "SSC registration Number must be numeric" }),
  ...
  hsc_registration_number: z
    ...
    .regex(/^\d+$/, { message: "HSC registration number must be numeric" }),
  ...
  birth_certificate_number: z
    .string()
    .min(1, { message: "Birth Certificate Number is required" })
    .regex(/^\d+$/, { message: "Birth Certificate Number must be numeric" }),

  nid_number: z
    .string()
    .min(1, { message: "NID Number is required" })
    .regex(/^\d+$/, { message: "NID Number must be numeric" }),
});
